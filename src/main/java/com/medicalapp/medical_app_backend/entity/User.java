...
public class User implements UserDetails {
    ...
    // ===== OTP / RESET CODE FIELDS =====
    // Used for both forgot-password reset codes and email verification codes
    ...
    // ===== HEALTH INFORMATION GETTERS AND SETTERS =====
    ...
    // ===== OTP / RESET CODE GETTERS AND SETTERS =====
    ...
    public String getScheduleSettings() { return scheduleSettings; }
    public void setScheduleSettings(String scheduleSettings) { this.scheduleSettings = scheduleSettings; }
